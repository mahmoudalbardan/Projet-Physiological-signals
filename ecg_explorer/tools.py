...
def plot_ecg(dir_,
    ...
    args = (fig_ecg, )
    names = ('ecg_plot', )
    name = "subject_"+subject_index+"_slalom_"+slalom_index+"_"+slalom_type+"_ecg"
    path = os.path.join(dir_,name)
    fig_ecg.savefig(path)
...
def tachogram(dir_,
    ...
    name = "subject_"+subject_index+"_slalom_"+slalom_index+"_"+slalom_type+"_tacho"
    path = os.path.join(dir_,name)
    fig.savefig(path)
    return biosppy.utils.ReturnTuple(args, names)
